            ...
            <div class="row">
                <div class="col-md-10">
                    <ul class="menu">
                        ...
                        <li><a href="{{ route('users') }}">Nhân  viên</a></li>
                        <li><a href="{{ route('authors') }}">Tác giả</a></li>
                        <li><a href="{{ route('publishers') }}">Nhà xuất bản</a></li>
                        <li><a href="{{ route('categories') }}">Danh mục sách</a></li>
                        <li><a href="{{ route('books') }}">Sách</a></li>
                        <li><a href="{{ route('readers') }}">Độc giả</a></li>
                        <li><a href="{{ route('book_issued') }}">Mượn sách</a></li>
