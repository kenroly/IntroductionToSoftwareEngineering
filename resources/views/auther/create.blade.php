    ...
    <div class="container">
        <div class="row">
            ...
            <div class="offset-md-7 col-md-2">
              <a class="add-new" href="{{ route('authors') }}">Danh sách tác giả</a>
            </div>
        </div>
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form class="yourform" action="{{ route('authors.store') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') isinvalid @enderror" placeholder="Tên tác giả" name="name" value="{{ old('name') }}" required>
                        @error('name')
